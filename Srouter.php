...
/**
 * @method static Srouter get(string $route, Callable $callback)
 * @method static Srouter post(string $route, Callable $callback)
 * @method static Srouter put(string $route, Callable $callback)
